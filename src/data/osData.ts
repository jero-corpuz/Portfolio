...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    client: "Thestarlightcabaret.com",
    category: "WordPress & Divi",
    excerpt:
      "Divi-powered nightlife and entertainment venue website seamlessly integrated with SquadUp for live event ticketing and table reservations.",
    description:
      "Built and customized a luxury cabaret and event venue web experience using WordPress and Divi theme builder, featuring real-time SquadUp ticketing integration, dynamic show schedules, and VIP reservation pathways.",
    year: "2024",
    technologies: ["WordPress", "Divi", "SquadUp", "PHP"],
    tags: ["WordPress", "Divi", "SquadUp", "Event Ticketing", "VIP Booking"],
    gradient: "from-purple-600 via-indigo-700 to-amber-900",
    stars: "5.0",
    metrics: "SquadUp Ticketing Sync",
    link: "https://thestarlightcabaret.com",
    coverImage: "/images/projects/starlight-cabaret/hero-bg.jpg",
    githubUrl: null,
    highlights: [
      "Integrated SquadUp ticketing engine for direct event booking and seamless checkout.",
      "Customized Divi child theme with responsive show schedules, performer highlights, and table booking workflows.",
      "Optimized media delivery and asset loading to ensure fast load speeds across desktop and mobile browsers.",
    ],
    solution:
      "Developed a bespoke WordPress & Divi site with SquadUp event integration, allowing visitors to view live show calendars and purchase tickets in an interactive modal.",
    impact:
      "Streamlined ticket sales and increased online event conversions through direct SquadUp checkout integration.",
  },
  {
    id: "gotham-comedy",
    slug: "gotham-comedy",
    ...
    category: "WordPress & Divi",
    excerpt:
      "Iconic New York City comedy venue website built on WordPress & Divi with Leap Events ticketing integration, dynamic show lineups, and venue rentals.",
    description:
      "Redesigned and customized the official web portal for Gotham Comedy Club in NYC using Divi on WordPress, featuring custom Leap Events ticketing integration, automated talent roster management, and VIP show reservations.",
    year: "2024",
    technologies: ["WordPress", "Divi", "Leap Events", "ShowClix"],
    tags: ["WordPress", "Divi", "Leap Events", "Ticketing UI", "Event Management"],
    gradient: "from-amber-600 via-rose-700 to-black",
    stars: "5.0",
    metrics: "Leap Events Integration",
    link: "https://gothamcomedyclub.com",
    coverImage: "/images/projects/gotham-comedy/homebanner.jpg",
    githubUrl: null,
    highlights: [
      "Integrated Leap Events (ShowClix) ticketing API for real-time ticket availability and seated reservations.",
      "Built a custom Divi layout with dynamic show schedules, comic lineup cards, and private event inquiry forms.",
      "Enhanced mobile UX and page performance for heavy weekend ticket purchase spikes.",
    ],
    solution:
      "Architected a high-traffic WordPress & Divi site integrated with Leap Events ticketing software, delivering frictionless show discovery and ticket checkout for NYC comedy fans.",
    impact:
      "Boosted direct ticket sales, simplified venue booking workflows, and elevated brand presence for a premier NYC comedy landmark.",
  },
  {
    id: "studio-wrx",
    slug: "studio-wrx",
